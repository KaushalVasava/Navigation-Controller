...
class ChooseReceiverFragment2 : Fragment(R.layout.fragment_choose_receiver){
    ...
    override fun onCreateView(
        ...
        binding.btnNext.setOnClickListener {
            ...
            val pendingIntent = NavDeepLinkBuilder(requireContext())
                ...
                .setArguments(SendCashFragment2Args.Builder(
                        receiverName
                    ).build().toBundle())
                .createPendingIntent()
...
//                .createPendingIntent()
        ...
        */
            val action = ChooseReceiverFragment2Directions.actionChooseReceiverFragment2ToSendCashFragment2(
                receiverName
            )
